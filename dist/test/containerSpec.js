    ...
    it('should use a custom factory', function () {
      ...
      var IncrementFactory = function (_ValueFactory) {
        ...
        function IncrementFactory() {
          ...
          return _possibleConstructorReturn(this, _ValueFactory.apply(this, arguments));
        }

        IncrementFactory.prototype.instantiate = function instantiate() {
          return counter++;
        };
    ...
    it('should accumulate All resolvers with the parent', function () {
      ...
      var C = function (_env$Plugin) {
        ...
        function C() {
          ...
          return _possibleConstructorReturn(this, _env$Plugin.apply(this, arguments));
        }
