...
var Container = function () {
  ...
  _createClass(Container, [{
    ...
    key: 'findBestFactory',
    value: function findBestFactory(key) {
      var entry = this._factories.get(key);
    ...
    key: 'findAllFactories',
    value: function findAllFactories(key) {
    ...
    key: 'resolveFactory',
    value: function resolveFactory(key) {
    ...
    key: 'constituteAll',
    value: function constituteAll(key) {
      var self = this;
    ...
    value: function getCachedInstance(key) {
      var factory = this.resolveFactory(key);
    ...
    key: 'schedulePostConstructor',
    value: function schedulePostConstructor(callback, constitutor) {
